...
is $chado_gff->features->{"continuous_feature_id"}->gene_start, 166, 'find gene start of CDS for continuous feature';
is $chado_gff->features->{"continuous_feature_id"}->gene_end,   231, 'find gene end of CDS for continuous feature';
is $chado_gff->features->{"continuous_feature_id"}->exon_length, 66, 'exon length for continuous feature';
is $chado_gff->features->{"continuous_feature_id"}->gene_strand,  1, 'strand of continuous feature';
is $chado_gff->features->{"continuous_feature_id"}->seq_id,  "FN543502", 'seq_id of continuous feature';
is $chado_gff->features->{"continuous_feature_id"}->locus_tag,  "continuous_feature_locus_tag", 'continuous feature locus tag';
...
is $cds_only_gff->features->{"continuous_feature_id"}->gene_start, 166, 'find gene start of CDS for continuous feature';
is $cds_only_gff->features->{"continuous_feature_id"}->gene_end,   231, 'find gene end of CDS for continuous feature';
is $cds_only_gff->features->{"continuous_feature_id"}->exon_length, 66, 'exon length for continuous feature';
is $cds_only_gff->features->{"continuous_feature_id"}->gene_strand,  1, 'strand of continuous feature';
is $cds_only_gff->features->{"continuous_feature_id"}->seq_id,  "FN543502", 'seq_id of continuous feature';
is $cds_only_gff->features->{"continuous_feature_id"}->locus_tag,  "continuous_feature_locus_tag", 'continuous feature locus tag';
...
is $old_chado_format_gff->features->{"continuous_feature_id"}->gene_start, 166, 'find gene start of CDS for continuous feature';
is $old_chado_format_gff->features->{"continuous_feature_id"}->gene_end,   231, 'find gene end of CDS for continuous feature';
is $old_chado_format_gff->features->{"continuous_feature_id"}->exon_length, 66, 'exon length for continuous feature';
is $old_chado_format_gff->features->{"continuous_feature_id"}->gene_strand,  1, 'strand of continuous feature';
is $old_chado_format_gff->features->{"continuous_feature_id"}->seq_id,  "FN543502", 'seq_id of continuous feature';
is $old_chado_format_gff->features->{"continuous_feature_id"}->locus_tag,  "continuous_feature_locus_tag", 'continuous feature locus tag';
