...
run_rna_seq_check_non_existance_of_a_feature('t/data/gffs_sams/mapping_to_one_feature_chado.sam','t/data/gffs_sams/multipurpose_3_cds_chado.gff', \@feature_names);
run_rna_seq_check_non_existance_of_a_feature_strand_specific('t/data/gffs_sams/mapping_to_one_feature_chado.sam','t/data/gffs_sams/multipurpose_3_cds_chado.gff', \@feature_names);


@expected_results_library = (
			['GreatCurl', 'Total Reads Mapping', 3,'Chado GFF gene 3 reads mapping flanking'],
			['GreatCurl', 'Sense Reads Mapping', 3,'Chado GFF gene 3 reads mapping flanking'],
			['GreatCurl', 'Antisense Reads Mapping', 0,'Chado GFF gene 3 reads mapping flanking'],
			['SplitHair', 'Total Reads Mapping', 0,'Chado GFF gene 3 reads mapping flanking'],
			['SplitHair', 'Sense Reads Mapping', 0,'Chado GFF gene 3 reads mapping flanking'],
			['SplitHair', 'Antisense Reads Mapping', 0,'Chado GFF gene 3 reads mapping flanking'],
		       );

run_rna_seq('t/data/gffs_sams/mapping_to_one_feature_chado.sam','t/data/gffs_sams/multipurpose_3_cds_chado.gff', \@expected_results_library,'DUMMY_CHADO_CHR');
...
run_rna_seq('t/data/gffs_sams/mapping_to_one_feature_annot.sam','t/data/gffs_sams/multipurpose_3_cds_annot.gff', \@expected_results_library,'DUMMY_ANNOT_CHR');
...
run_rna_seq('t/data/gffs_sams/mapping_to_one_feature_embl.sam','t/data/gffs_sams/multipurpose_3_cds_embl.gff', \@expected_results_library,'DUMMY_EMBL_CHR');
...
run_rna_seq_check_non_existance_of_a_feature('t/data/gffs_sams/mapping_to_one_feature_mammal.sam','t/data/gffs_sams/multipurpose_3_genes_mammal_gtf2gff3.gff', \@feature_names);
run_rna_seq_check_non_existance_of_a_feature_strand_specific('t/data/gffs_sams/mapping_to_one_feature_mammal.sam','t/data/gffs_sams/multipurpose_3_genes_mammal_gtf2gff3.gff', \@feature_names);
...
run_rna_seq('t/data/gffs_sams/mapping_to_one_feature_mammal.sam','t/data/gffs_sams/multipurpose_3_genes_mammal_gtf2gff3.gff', \@expected_results_library,'DUMMY_MAMMAL_CHR');
