...
sub _build__slice_file_handle
{
  ...
  open($slice_file_handle, $self->_slice_stream ) || Bio::RNASeq::Exceptions::FailedToOpenAlignmentSlice->throw( error => "Cant view slice for ".$self->filename." ".$self->_window_start." " .$self->_window_end );
