...
Bio::RNASeq::VertRes::Parser::fastq - parse fastq files
...
my $pars = Bio::RNASeq::VertRes::Parser::fastq->new(file => 'read.fastq.gz');
...
package Bio::RNASeq::VertRes::Parser::fastq;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::fastq->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::fastq object.
 Returns : Bio::RNASeq::VertRes::Parser::fastq object
