...
Bio::RNASeq::VertRes::Parser::sequence_index - parse sequence.index files from the DCC
...
my $pars = Bio::RNASeq::VertRes::Parser::sequence_index->new(file => 'sequence.index');
...
package Bio::RNASeq::VertRes::Parser::sequence_index;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::sequence_index->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::sequence_index object.
 Returns : Bio::RNASeq::VertRes::Parser::sequence_index object
