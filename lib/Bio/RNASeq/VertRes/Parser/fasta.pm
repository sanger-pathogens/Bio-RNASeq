...
Bio::RNASeq::VertRes::Parser::fasta - parse fasta files
...
my $pars = Bio::RNASeq::VertRes::Parser::fasta->new(file => 'read.fasta.gz');
...
package Bio::RNASeq::VertRes::Parser::fasta;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::fasta->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::fasta object.
 Returns : Bio::RNASeq::VertRes::Parser::fasta object
