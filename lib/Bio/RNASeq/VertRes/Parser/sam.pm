...
Bio::RNASeq::VertRes::Parser::sam - parse the sam format
...
my $pars = Bio::RNASeq::VertRes::Parser::sam->new(file => 'mapping.sam');
...
$pars = Bio::RNASeq::VertRes::Parser::sam->new(file => 'mapping.bam');
...
package Bio::RNASeq::VertRes::Parser::sam;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::sam->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::sam object.
 Returns : Bio::RNASeq::VertRes::Parser::sam object
