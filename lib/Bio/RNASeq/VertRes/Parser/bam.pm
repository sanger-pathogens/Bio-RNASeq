...
Bio::RNASeq::VertRes::Parser::bam - parse and write bam files
...
my $pars = Bio::RNASeq::VertRes::Parser::bam->new(file => 'my.bam');
...
package Bio::RNASeq::VertRes::Parser::bam;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::bam->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::bam object.
 Returns : Bio::RNASeq::VertRes::Parser::bam object
 Args    : file => filename
