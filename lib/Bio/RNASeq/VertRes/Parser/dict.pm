...
Bio::RNASeq::VertRes::Parser::dict - parse sequence dictionary files
...
my $pars = Bio::RNASeq::VertRes::Parser::dict->new(file => 'reference.dict');
...
package Bio::RNASeq::VertRes::Parser::dict;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::dict->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::dict object.
 Returns : Bio::RNASeq::VertRes::Parser::dict object
