...
Bio::RNASeq::VertRes::Parser::fastqcheck - parse fastqcheck files
...
my $pars = Bio::RNASeq::VertRes::Parser::fastqcheck->new(file => 'read.fastq.gz.fastqcheck');
...
package Bio::RNASeq::VertRes::Parser::fastqcheck;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::fastqcheck->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::fastqcheck object.
 Returns : Bio::RNASeq::VertRes::Parser::fastqcheck object
