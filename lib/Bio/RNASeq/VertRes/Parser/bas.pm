...
Bio::RNASeq::VertRes::Parser::bas - parse bas files
...
my $pars = Bio::RNASeq::VertRes::Parser::bas->new(file => 'raw.bam.bas');
...
Bio::RNASeq::VertRes::Utils::Sam->bas().
...
package Bio::RNASeq::VertRes::Parser::bas;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::bas->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::bas object.
 Returns : Bio::RNASeq::VertRes::Parser::bas object
