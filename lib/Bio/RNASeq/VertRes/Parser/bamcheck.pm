...
Bio::RNASeq::VertRes::Parser::bamcheck - parse bamcheck files
...
=head1 SYNOPSIS
    ...
    my $pars = Bio::RNASeq::VertRes::Parser::bamcheck->new(file => 'file.bam.bc');
...
package Bio::RNASeq::VertRes::Parser::bamcheck;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Parser::bamcheck->new(file => 'filename');
 Function: Build a new Bio::RNASeq::VertRes::Parser::bamcheck object.
 Returns : Bio::RNASeq::VertRes::Parser::bamcheck object
