...
Bio::RNASeq::VertRes::Wrapper::WrapperI - interface for wrapper modules

=head1 SYNOPSIS

package Bio::RNASeq::VertRes::Wrapper::MyWrapper;
...
package main;
use Bio::RNASeq::VertRes::Wrapper::MyWrapper;

my $wrapper = Bio::RNASeq::VertRes::Wrapper::MyWrapper->new(param2 => 17, switch1 => 1);
...
package Bio::RNASeq::VertRes::Wrapper::WrapperI;
