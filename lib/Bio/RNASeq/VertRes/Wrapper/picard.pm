...
Bio::RNASeq::VertRes::Wrapper::picard - wrapper for picard tools

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Wrapper::picard;

my $wrapper = Bio::RNASeq::VertRes::Wrapper::picard->new(validation_stringency => 'silent');
...
package Bio::RNASeq::VertRes::Wrapper::picard;
...
sub rmdup {
    ...
    my $st = Bio::RNASeq::VertRes::Wrapper::samtools->new(quiet => 1);
    $st->run_method('open');
