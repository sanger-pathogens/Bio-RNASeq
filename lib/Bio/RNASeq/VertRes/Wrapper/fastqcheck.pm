...
Bio::RNASeq::VertRes::Wrapper::fastqcheck - wrapper for fastqcheck

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Wrapper::fastqcheck;

my $wrapper = Bio::RNASeq::VertRes::Wrapper::fastqcheck->new();
...
package Bio::RNASeq::VertRes::Wrapper::fastqcheck;
...
=head2 new
 ...
 Title   : new
 Usage   : my $wrapper = Bio::RNASeq::VertRes::Wrapper::fastqcheck->new();
 Function: Create a Bio::RNASeq::VertRes::Wrapper::fastqcheck object.
 Returns : Bio::RNASeq::VertRes::Wrapper::fastqcheck object
 Args    : quiet => boolean
