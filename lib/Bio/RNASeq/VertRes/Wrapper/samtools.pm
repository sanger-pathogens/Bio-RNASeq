...
Bio::RNASeq::VertRes::Wrapper::samtools - wrapper for samtools

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Wrapper::samtools;

my $wrapper = Bio::RNASeq::VertRes::Wrapper::samtools->new();
...
package Bio::RNASeq::VertRes::Wrapper::samtools;
...
BEGIN { eval 'use Bio::RNASeq::VertRes::Utils::Sam'; if ($@) { die "$@\n"; } }

use base qw(Bio::RNASeq::VertRes::Wrapper::WrapperI);


=head2 new

 Title   : new
 Usage   : my $wrapper = Bio::RNASeq::VertRes::Wrapper::samtools->new();
 Function: Create a Bio::RNASeq::VertRes::Wrapper::samtools object.
 Returns : Bio::RNASeq::VertRes::Wrapper::samtools object
 Args    : quiet   => boolean
