...
Bio::RNASeq::VertRes::Base - base module that all VertRes modules inherit from

=head1 SYNOPSIS

package Bio::RNASeq::VertRes::MyNewModule;
...
sub example_sub {
    ...
    eval {
        my $other = Bio::RNASeq::VertRes::othermodule->new()
    ...
    my $other = Bio::RNASeq::VertRes::othermodule->new(verbose => 1);
    $other->verbose(2);
...
package Bio::RNASeq::VertRes::Base;
...
=head2 verbose
 ...
 Usage   : $self->verbose(1); # per-object
           Bio::RNASeq::VertRes::Base::verbose(1); # global
