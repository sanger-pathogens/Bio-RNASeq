...
Bio::RNASeq::VertRes::Utils::Mapping - mapping utility functions

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mapping;

# get the mapping utility object appropriate for the lane's technology
my $chooser = Bio::RNASeq::VertRes::Utils::Mapping->new();
my $class = $chooser->lane_to_module('/path/to/SLX/lane');
# $class is Bio::RNASeq::VertRes::Utils::Mappers::SLX
require $class;
...
package Bio::RNASeq::VertRes::Utils::Mapping;
...
use File::Basename;
use Bio::RNASeq::VertRes::Utils::Hierarchy;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mapping->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mapping object.
 Returns : Bio::RNASeq::VertRes::Utils::Mapping object
...
sub lane_to_module {
    ...
    return "Bio::RNASeq::VertRes::Utils::Mappers::$mapper";
}
...
sub split_fastq {
    ...
    my $fastq_util = Bio::RNASeq::VertRes::Utils::FastQ->new(verbose => $self->verbose);
...
=head2 wrapper
 ...
 Returns : Bio::RNASeq::VertRes::Wrapper::WrapperI-based object (call do_mapping() on it)
 Args    : n/a
...
=head2 _do_mapping_args
 ...
 Args    : a hash ref with keys as the generic optional args understood by
           Bio::RNASeq::VertRes::Utils::Mapping::do_mapping(), and values as the args
...
sub mapping_hierarchy_report {
    ...
    my %hierarchy_stats;
    my $hu = Bio::RNASeq::VertRes::Utils::Hierarchy->new();
...
=head2 get_mapping_stats
 ...
 Function: Extract/calculate most commonly needed stats from a .bas file
           (produced by Bio::RNASeq::VertRes::Utils::Sam->stats() or ->bas()) or a
...
sub get_mapping_stats {
    ...
    if (ref($thing) && $thing->isa('VRTrack::Mapstats')) {
        ...
        my $bas_parser = Bio::RNASeq::VertRes::Parser::bas->new(file => $thing);
