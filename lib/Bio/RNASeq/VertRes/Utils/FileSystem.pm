...
Bio::RNASeq::VertRes::Utils::FileSystem - do filesystem manipulations
...
package Bio::RNASeq::VertRes::Utils::FileSystem;
...
=head2 new
 ...
 Function: Instantiate a new Bio::RNASeq::VertRes::Utils::FileSystem object.
