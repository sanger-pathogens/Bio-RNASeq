...
Bio::RNASeq::VertRes::Utils::Math - math utility functions
...
package Bio::RNASeq::VertRes::Utils::Math;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Math->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Math object.
 Returns : Bio::RNASeq::VertRes::Utils::Math object
 Args    : n/a
