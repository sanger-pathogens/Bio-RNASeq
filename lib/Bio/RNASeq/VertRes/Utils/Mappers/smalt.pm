...
Bio::RNASeq::VertRes::Utils::Mappers::smalt - mapping utility functions

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mappers::smalt;

my $mapping_util = Bio::RNASeq::VertRes::Utils::Mappers::smalt->new();
...
package Bio::RNASeq::VertRes::Utils::Mappers::smalt;

use strict;
use warnings;
use Bio::RNASeq::VertRes::Wrapper::smalt;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mappers::smalt->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mappers::smalt object.
 Returns : Bio::RNASeq::VertRes::Utils::Mappers::smalt object
 Args    : n/a
...
=head2 wrapper
 ...
 Returns : Bio::RNASeq::VertRes::Wrapper::smalt object (call do_mapping() on it)
 Args    : n/a
...
sub wrapper {
    ...
    return Bio::RNASeq::VertRes::Wrapper::smalt->new(verbose => $self->verbose, exe => $exe);
}
