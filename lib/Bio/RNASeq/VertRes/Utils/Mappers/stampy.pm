...
Bio::RNASeq::VertRes::Utils::Mappers::stampy - mapping utility functions, stampy-specific

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mappers::stampy;

my $mapping_util = Bio::RNASeq::VertRes::Utils::Mappers::stampy->new();
...
package Bio::RNASeq::VertRes::Utils::Mappers::stampy;

use strict;
use warnings;
use Bio::RNASeq::VertRes::Wrapper::stampy;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mappers::stampy->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mappers::stampy object.
 Returns : Bio::RNASeq::VertRes::Utils::Mappers::stampy object
 Args    : n/a
...
=head2 wrapper
 ...
 Returns : Bio::RNASeq::VertRes::Wrapper::stampy object (call do_mapping() on it)
 Args    : n/a
...
sub wrapper {
    ...
    return Bio::RNASeq::VertRes::Wrapper::stampy->new(verbose => $self->verbose, exe => $exe);
}
