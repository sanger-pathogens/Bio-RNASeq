...
Bio::RNASeq::VertRes::Utils::Mappers::ssaha - mapping utility functions, ssaha-specific

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mappers::ssaha;

my $mapping_util = Bio::RNASeq::VertRes::Utils::Mappers::ssaha->new();
...
package Bio::RNASeq::VertRes::Utils::Mappers::ssaha;

use strict;
use warnings;
use Bio::RNASeq::VertRes::Wrapper::ssaha;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mappers::ssaha->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mappers::ssaha object.
 Returns : Bio::RNASeq::VertRes::Utils::Mappers::ssaha object
 Args    : n/a
...
sub _bsub_opts {
    ...
    if ($action eq 'map') {
        $bsub_opts{bsub_opts} = '-q long -R \'select[type==X86_64] rusage[tmp=35000]\'';
    }
    else {
...
=head2 wrapper
 ...
 Returns : Bio::RNASeq::VertRes::Wrapper::bwa object (call do_mapping() on it)
 Args    : n/a
...
sub wrapper {
    ...
    return Bio::RNASeq::VertRes::Wrapper::ssaha->new(verbose => $self->verbose,
