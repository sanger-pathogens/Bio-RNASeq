...
Bio::RNASeq::VertRes::Utils::Mappers::bwa - mapping utility functions, bwa-specific

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mappers::bwa;

my $mapping_util = Bio::RNASeq::VertRes::Utils::Mappers::bwa->new();
...
package Bio::RNASeq::VertRes::Utils::Mappers::bwa;

use strict;
use warnings;
use Bio::RNASeq::VertRes::Wrapper::bwa;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mappers::bwa->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mappers::bwa object.
 Returns : Bio::RNASeq::VertRes::Utils::Mappers::bwa object
 Args    : n/a
...
sub wrapper {
    my $self = shift;
    my $exe = $self->{exe} || 'bwa';
    return Bio::RNASeq::VertRes::Wrapper::bwa->new(verbose => $self->verbose, exe => $exe);
}
