...
Bio::RNASeq::VertRes::Utils::Mappers::tophat - mapping utility functions

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Mappers::tophat;

my $mapping_util = Bio::RNASeq::VertRes::Utils::Mappers::tophat->new();
...
package Bio::RNASeq::VertRes::Utils::Mappers::tophat;

use strict;
use warnings;
use Bio::RNASeq::VertRes::Wrapper::tophat;
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Mappers::tophat->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Mappers::tophat object.
 Returns : Bio::RNASeq::VertRes::Utils::Mappers::tophat object
 Args    : n/a
...
=head2 wrapper
 ...
 Returns : Bio::RNASeq::VertRes::Wrapper::tophat object (call do_mapping() on it)
 Args    : n/a
...
sub wrapper {
    ...
    return Bio::RNASeq::VertRes::Wrapper::tophat->new(verbose => $self->verbose, exe => $exe);
}
