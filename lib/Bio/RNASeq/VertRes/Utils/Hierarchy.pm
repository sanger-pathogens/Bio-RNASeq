...
Bio::RNASeq::VertRes::Utils::Hierarchy - hierarchy utility functions

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::Hierarchy;

my $hierarchy_util = Bio::RNASeq::VertRes::Utils::Hierarchy->new();
...
package Bio::RNASeq::VertRes::Utils::Hierarchy;
...
our $nfs_disc_basename = Bio::RNASeq::VertRes::Utils::VRTrackFactory->nfs_disc_basename();


=head2 new

 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::Hierarchy->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::Hierarchy object.
 Returns : Bio::RNASeq::VertRes::Utils::Hierarchy object
 Args    : n/a
...
=head2 lane_info
 ...
 Args    : lane name (read group) OR a VRTrack::Lane object.
           ...
           variables, as per Bio::RNASeq::VertRes::Utils::VRTrackFactory):
           db => {
            host => 'xxx',
            port => xxx,
            user => 'xxx',
...
sub check_lanes_vs_sequence_index {
    ...
    my $sip = Bio::RNASeq::VertRes::Parser::sequence_index->new(file => $sequence_index,
...
sub lane_bams {
    ...
    if ($mappings && @{$mappings}) {
        ...
        my $mapping_util = Bio::RNASeq::VertRes::Utils::Mapping->new(slx_mapper => $mapper_slx,
...
sub dcc_filename {
    ...
    if (defined $self->{rginfo}->{$file}) {
        ...
        my $bp = Bio::RNASeq::VertRes::Parser::bam->new(file => $file);
    ...
    if ($sequence_index) {
        ...
        if (defined $self->{sip}->{$sequence_index}) {
            ...
            $sip = Bio::RNASeq::VertRes::Parser::sequence_index->new(file => $sequence_index,
                                                        verbose => $self->verbose);
