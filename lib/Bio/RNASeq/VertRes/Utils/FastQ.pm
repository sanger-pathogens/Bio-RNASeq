...
Bio::RNASeq::VertRes::Utils::FastQ - fastq utility functions

=head1 SYNOPSIS

use Bio::RNASeq::VertRes::Utils::FastQ;

my $fastq_util = Bio::RNASeq::VertRes::Utils::FastQ->new();
...
package Bio::RNASeq::VertRes::Utils::FastQ;
...
use Bio::RNASeq::VertRes::Parser::fastq;
use Cwd 'abs_path';
...
=head2 new
 ...
 Title   : new
 Usage   : my $obj = Bio::RNASeq::VertRes::Utils::FastQ->new();
 Function: Create a new Bio::RNASeq::VertRes::Utils::FastQ object.
 Returns : Bio::RNASeq::VertRes::Utils::FastQ object
 Args    : n/a
...
sub split {
    ...
    my $fqc = Bio::RNASeq::VertRes::Parser::fastqcheck->new();
    my $total_bases = 0;
    my $num_fqcs = 0;
    foreach my $fastq_file (@{$fastqs}) {
        ...
        my $in = Bio::RNASeq::VertRes::IO->new(file => $fastq_file, verbose => $self->verbose);
        ...
        my $out = Bio::RNASeq::VertRes::IO->new(file => ">$split_file", verbose => $self->verbose);
...
sub filter_reads {
    ...
    my $i = Bio::RNASeq::VertRes::IO->new(file => $in);
    my $ifh = $i->fh;
    my $o = Bio::RNASeq::VertRes::IO->new(file => ">$out");
    my $ofh = $o->fh;
...
sub clip_point {
    ...
    my $fp = Bio::RNASeq::VertRes::Parser::fastq->new(file => $fastq);
